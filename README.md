...
## Power BI Dashboard
A Power BI dashboard visualizing extreme weather data is included in the repository:

- File: `powerbi/StormDashboard.pbix`
- To view the interactive dashboard, download the file and open it in **Power BI Desktop**.

For a preview, see screenshots or GIFs in the `images/` folder.
